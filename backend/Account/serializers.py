...
class EmailVerificationSerializer(serializers.ModelSerializer):
    ...
    uid = serializers.CharField(max_length=555)
...
class LoginSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserAccount
        fields = ['email', 'password', 'username', 'tokens','User_detail_id','last_login']
...
class SetNewPasswordSerializer(serializers.Serializer):
    ...
    class Meta:
        fields = ['password', 're_password', 'token', 'uid']
...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = UserAccount
        fields = ('id','username', 'email', 'User_detail_id')
